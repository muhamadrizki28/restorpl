                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <a class="btn btn-primary btn-block" href="{{ url('/menu') }}">{{ ( Auth::user()->level == 1 ? 'Kelola Menu Warkan' : 'Daftar Menu yang Tersedia' ) }}</a>
                        </div>
                        <div class="col-12 col-sm-6">
                            <a class="btn btn-primary btn-block" href="{{ url('/meja') }}">{{ ( Auth::user()->level == 1 ? 'Kelola Meja Warkan' : ( Auth::user()->level == 2 ? 'Buat Pesanan' : 'Meja Kosong' ) ) }}</a>
                        </div>
                    </div>
                </div>
            </div>
