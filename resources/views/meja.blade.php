            ...
            <div class="card mt-4">
                <div class="card-header">
                    <form method="POST" action="{{ route('meja.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-6 text-left align-self-center">List Meja Warkan</div>
                            <div class="col-6 text-right">
                                @if( $user->level == '1' )
                                <input type="hidden" name="status" value="1"><button id="sub" type="submit" class="btn btn-primary btn-sm">Tambah Meja Warkan</button>
                                @endif
                            </div>
                        </div>
                    </form>
